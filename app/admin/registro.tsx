...
export default function AdminRegistroScreen() {
  ...
  const handleSaveAnimal = () => {
    if (!animalName || !breed || !dateOfBirth || !ownerEmail) {
      ...
      <ScrollView style={styles.main} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.scannerSection}>
          ...
          <Text style={styles.scannerDescription}>
            Connect your Bluetooth reader and scan the animal RFID tag to link
            it.
          </Text>
